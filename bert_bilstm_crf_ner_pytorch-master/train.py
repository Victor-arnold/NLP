...
def train():
    ...
    if config.do_train:
        ...
        bert_config = BertConfig.from_pretrained(config.model_name_or_path, num_labels=num_labels) # num_labels: 3
